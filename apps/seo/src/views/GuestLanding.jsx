...
import { Search, Globe, FileText, Building2, ArrowUpRight, Zap } from 'lucide-react';
...
export default function GuestLanding() {
	...
	return (
		<div className="space-y-6 max-w-6xl pb-12">
			<PageHeader
				title="SEO & Schema Intelligence • Operations Hub"
				subtitle="Global operational status, connected merchant statistics, hourly feature pricing, and direct crawl engine"
				actions={
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
				...
				<StatCard title="Active Domain Storefronts" value={totalWebsites.toString()} trend="Crawl Coverage" />
				<StatCard title="Pages Audited (24h)" value="3,180" trend="+14.5% index" />
				<StatCard title="Avg SEO Health Score" value="94/100" trend="Grade A+" />
			</div>
				...
				<div className="space-y-3">
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
						{(features.length > 0
							? features
							: [
									{ id: 'crawler_audit', name: 'Real-Time Health Crawler', hourlyPrice: 0.009, category: 'Core' },
									{
										id: 'json_ld_schema',
										name: 'JSON-LD Rich Snippet Generator',
										hourlyPrice: 0.007,
										category: 'Schema',
									},
									{
										id: 'sitemap_validator',
										name: 'XML Sitemap & Index Checker',
										hourlyPrice: 0.005,
										category: 'Index',
									},
								]
