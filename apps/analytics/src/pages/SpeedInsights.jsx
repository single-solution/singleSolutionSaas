...
export default function SpeedInsights() {
	const { activeStore, stores, analyticsData, hasStoreFeature, storeEvents } = useStorefront();
	...
	if (!hasStoreFeature('speed_vitals')) {
		return (
			<FeatureLockScreen
				featureName="Core Web Vitals Real-Device Telemetry"
				creditCost={25}
