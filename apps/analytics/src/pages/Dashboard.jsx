	...
	return (
		<div className="space-y-6 antialiased text-slate-900">
								...
								{Object.entries(analyticsData.vitals)
									...
									.map(([key, item]) => (
										<button
											...
											className="p-2.5 rounded-xl bg-white border border-slate-200 text-left hover:border-indigo-300 transition-all cursor-pointer">
			...
			<Card
				...
				action={
					<Link to="/funnel" className="text-xs text-indigo-600 hover:text-indigo-800 font-bold flex items-center gap-1">
			...
			<Card
				...
				action={
					<Link to="/events" className="text-xs text-indigo-600 hover:text-indigo-800 font-bold flex items-center gap-1">
